...
static tracy_force_inline void ProcessRGB_AVX( const uint8_t* src, char*& dst )
{
    ...
    __m256i mmr = _mm256_and_si256( mm2, _mm256_set_epi16( 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800 ) );
    __m256i mmg = _mm256_srli_epi64( _mm256_and_si256( mm2, _mm256_set_epi16( 0x0000, 0x0000, 0xFC00, 0x0000, 0x0000, 0x0000, 0xFC00, 0x0000, 0x0000, 0x0000, 0xFC00, 0x0000, 0x0000, 0x0000, 0xFC00, 0x0000 ) ), 21 );
    __m256i mmb = _mm256_srli_epi64( _mm256_and_si256( mm2, _mm256_set_epi16( 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000, 0x0000, 0xF800, 0x0000, 0x0000 ) ), 43 );
