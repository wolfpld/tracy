...
public:
    ...
    {
        m_sorted &= m_images.empty() || ( entry.m_startAddress < m_images.back().m_startAddress );
...
private:
    ...
    static int Callback( struct dl_phdr_info* info, size_t size, void* data )
    {
        ...
        image.m_name = info->dlpi_name && info->dlpi_name[0] != '\0' ? CopyString( info->dlpi_name ) : nullptr;
